...
const STATIC_WEBCAMS = [
  ...
  { webcamId: 90011, title: 'Kaş — Kalkan Views', status: 'active', lastUpdatedOn: new Date().toISOString(), location: { latitude: 36.2000, longitude: 29.6400, city: 'Kaş', country: 'Turkey' }, player: { day: 'https://worldcam.eu/webcams/asia/turkey/12823-kalkan-several-views' } },
